...
Our primary measurements are conducted on an NVIDIA A100-SXM4-40GB (sm\_80) GPU, with cross-architecture replay on A100-PCIE-40GB (same sm\_80) and H100-80GB-HBM3 (sm\_90) confirming that the gaps generalize across form factors and GPU families. The results nonetheless characterize NVIDIA datacenter platforms rather than all accelerators; in particular, we do not evaluate ROCm or Intel XPU backends, although these are important targets for future work.
