...
Our own sweep illustrates both the hazard and its cost: tuning at a shape smaller than deployment can select a configuration \emph{slower than the untuned default}, and tuning at the deployment shape---the obvious remedy---is expensive, because each candidate must be timed on the full-size problem.
