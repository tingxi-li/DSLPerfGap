...
These are not adversarial constructions: they differ from a competent implementation in a single reduction primitive (\cref{sec:analysis:jit}); \cref{fig:serial-vs-reduce} shows the two-line fix.
