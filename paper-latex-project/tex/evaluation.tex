...
These figures are for the \emph{idiomatic} kernels shipped in each DSL's examples; RQ3 (\cref{sec:mitigation}) shows that reduction and normalization gaps are authoring artifacts, whereas the convolution and large-GEMM gaps persist as genuine residuals.
