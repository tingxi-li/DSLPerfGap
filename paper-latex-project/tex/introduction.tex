...
Primary measurements use an NVIDIA GH200 (Hopper); cross-architecture replay on A100-SXM4 and RTX~4000~Ada is reported in \cref{sec:threats}.% TODO(revision): finalize primary/cross GPU list after the multi-GPU re-baseline.
